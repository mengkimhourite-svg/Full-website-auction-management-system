...
import { ArrowRight, Shield, Zap, Sparkles, TrendingUp, Award } from "lucide-react";
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-gradient-to-br from-slate-950 via-indigo-950 to-slate-900">
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute top-40 right-20 w-16 h-16 border border-purple-400/20 rounded-xl -rotate-6 animate-float-slow" style={{ animationDelay: '1s' }} />
        <div className="absolute bottom-40 left-1/4 w-20 h-20 border border-indigo-400/20 rounded-full animate-float-slow" style={{ animationDelay: '2s' }} />
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="animate-slide-left">
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              <Link
                href="/auctions"
                className="group inline-flex items-center gap-2.5 px-8 py-4 bg-gradient-to-r from-yellow-500 to-amber-600 text-white rounded-2xl font-bold text-base shadow-xl shadow-amber-900/30 hover:shadow-2xl hover:shadow-amber-900/40 hover:-translate-y-0.5 transition-all duration-300"
              >
            ...
            <div className="relative">
              ...
              <div className="relative bg-white/5 backdrop-blur-sm rounded-3xl p-3 border border-white/10 shadow-2xl">
                <img
                  ...
                  className="rounded-2xl h-[420px] sm:h-[500px] w-full object-cover"
                />
              </div>
              <div className="absolute inset-0 rounded-2xl ring-1 ring-white/10 pointer-events-none" />
            </div>

            <div className="absolute -bottom-6 -left-6 bg-white/10 backdrop-blur-xl rounded-2xl px-6 py-4 border border-white/10 shadow-xl animate-float" style={{ animationDelay: '0.5s' }}>
              <p className="text-3xl font-extrabold text-white">10,000+</p>
              <p className="text-white/60 text-sm mt-0.5">Active Auctions</p>
            </div>

            <div className="absolute -top-4 -right-4 bg-gradient-to-r from-yellow-400 to-amber-600 text-white rounded-2xl px-5 py-3.5 shadow-xl animate-float" style={{ animationDelay: '1s' }}>
              <p className="text-2xl font-extrabold">98%</p>
              <p className="text-yellow-100 text-sm">Satisfaction Rate</p>
            </div>
          </div>
        </div>
      </div>
