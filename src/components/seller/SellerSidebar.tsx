...
const links = [
  ...
  { label: "Create Auction", href: "/seller/creations", icon: PlusCircle },
      ...
      <aside className={`dashboard-sidebar ${open ? "open" : ""}`}>
        <div className="flex items-center justify-between p-5 border-b border-gray-100">
          <Link href="/" className="flex items-center gap-2.5 no-underline">
            ...
            />
            <span className="text-base font-extrabold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">Seller</span>
          </Link>
        ...
        <div className="px-3 py-4">
          <p className="px-3 text-xs font-semibold text-gray-400 uppercase tracking-wider mb-3">Seller Panel</p>
